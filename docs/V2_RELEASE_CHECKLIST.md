...
- 岗位标准版本历史和批量重新评分。
- 岗位内上传和统一上传。
- 规则+AI 简历结构化抽取，覆盖教育、工作、项目、证书、语言、奖项和自我评价。
- 上传队列、失败重试、重复风险统计。
...
V2 当前可以作为“可试用招聘工作台”进入稳定化交付。项目已经收缩为 V2 交付闭环，下一步只围绕验收、演示、启动说明和阻断缺陷修复收口；报告历史、文本粘贴、ZIP、PDF / Word 导出等新能力进入下一大版本统一规划。
